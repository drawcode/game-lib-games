...
public class BaseGamePlayerIndicator : MonoBehaviour {
    ...
    GamePlayerIndicatorItem gamePlayerIndicatorItem;
    ...
    public static GamePlayerIndicator AddIndicator(GameObject target, GamePlayerIndicatorType type) {
        return GamePlayerIndicator.AddIndicator(target, type.ToString());
    }

    public static GamePlayerIndicator AddIndicator(GameObject target, GamePlayerIndicatorType type, Color colorTo) {
        return GamePlayerIndicator.AddIndicator(target, type.ToString(), colorTo);
    }

    // STRING

    public static GamePlayerIndicator AddIndicator(GameObject target, string gameIndicatorType) {
        return GamePlayerIndicator.AddIndicator(target, "default", gameIndicatorType);
    }

    public static GamePlayerIndicator AddIndicator(GameObject target, string gameIndicatorType, Color colorTo) {
    ...
    public static GamePlayerIndicator AddIndicator(GameObject target, string type, string gameIndicatorType) {
        return GamePlayerIndicator.AddIndicator(GameHUD.Instance.containerOffscreenIndicators,
            target, type, gameIndicatorType);
    }

    public static GamePlayerIndicator AddIndicator(GameObject parentObject, GameObject target, string gameIndicatorType) {
        return GamePlayerIndicator.AddIndicator(parentObject, target, "default", gameIndicatorType);
    }

    public static GamePlayerIndicator AddIndicator(GameObject parentObject, GameObject target, string type, string gameIndicatorType) {
        // Spawn indicator
        // target new player
    ...
    public void SetIndicatorColorEffects(Color colorTo) {
        if(gamePlayerIndicatorItem != null) {
            gamePlayerIndicatorItem.SetColorValueEffects(colorTo);
        }
    }

    public void SetIndicatorColorBackground(Color colorTo) {
        if(gamePlayerIndicatorItem != null) {
            gamePlayerIndicatorItem.SetColorValueBackground(colorTo);
        }
    }

    public void SetIndicatorColorOutline(Color colorTo) {
        if(gamePlayerIndicatorItem != null) {
            gamePlayerIndicatorItem.SetColorValueOutline(colorTo);
        }
    }
 
    public void SetGameIndicatorType(string gameIndicatorType) {
    ...
    public void SetTarget(Transform targetTo) {
    ...
    public void HideIndicator(bool destroy) {
        if(visible) {
            visible = false;
    ...
    public void SetIndicatorPlacementType(GamePlayerIndicatorPlacementType indicatorTypeTo) {
        indicatorType = indicatorTypeTo;
    }
 
    public void SetIndicatorObject(GameObject indicatorObjectTo) {
    ...
    void UpdateIndicator(Vector3 relativePosition) {
